...
function activedemand_plugin_options()
{
    ...
    <div class="wrap">
        ...
        <?php if ("" == $activedemand_appkey || !isset($activedemand_appkey)) { ?>
            <div>
                <h3>To sign up for your ActiveDEMAND account, click <a href="http://1jp.cc/s/vaiXT"><strong>here</strong></a>
                </h3>
                <p>
        ...
        <?php if ("" != $activedemand_appkey) { ?>
            <div>
                ...
                ?>
                <?php if ("" != $xml) { ?>
                    <h3>Available Web Form Short Codes</h3><br/>
                ...
                <?php } else {?>
                    ...
                    <p>To use the ActiveDEMAND web form shortcodes, you will first have to add some webforms to your account in ActiveDEMAND. Once you do have webforms configured, the available shortcodes will be displayed here.</p>
                <?php }?>
            </div>
        <?php } ?>
    </div>
